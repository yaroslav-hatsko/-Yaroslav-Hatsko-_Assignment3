...
for sale in sales_data:
    ...
    old_revenue = category_report[category]["total_revenue"]
    new_revenue = old_revenue + revenue
    category_report[category]["total_revenue"] = new_revenue
    old_items_sold = category_report[category]["total_items_sold"]
    new_items_sold = old_items_sold + quantity
    category_report[category]["total_items_sold"] = new_items_sold
